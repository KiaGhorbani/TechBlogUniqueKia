...
class GradientColors {
  static const List<Color> bottomNavigation = [Color.fromARGB(255,25,0,94), Color.fromARGB(255, 68, 4, 87) ];
  //static const List<Color> bottomNavigation = [const Color.fromARGB(255,25,0,94), const Color.fromARGB(255, 68, 4, 87) ];
}
